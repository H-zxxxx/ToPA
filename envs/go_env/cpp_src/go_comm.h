...
// 新增: 利用条件编译来改变棋盘大小(g++编译指令加上-D BOARD9x9)
#ifdef BOARD9x9
#define __MACRO_BOARD_SIZE 9
#define __MACRO_MAX_BLOCK 64

// 需要其他尺寸在此处添加
// 如 #ifdef BOARD13x13...

#else
#define __MACRO_BOARD_SIZE 19   // (宏)棋盘大小
#define __MACRO_MAX_BLOCK 256   // (宏)最大连通块数
...
const int BOARD_SIZE = __MACRO_BOARD_SIZE;          // 棋盘尺寸
